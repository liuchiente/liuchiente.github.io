...
![image](images/2021-02-boundary-extraction-region-filling-2937420103425359984.png)


一張簡單的二值化影像，影像中只有全黑、全白兩種像素 

![image](images/2021-02-boundary-extraction-region-filling-4934726797766642128.png)
...
 １.Boundary Extraction測試原圖

![image](images/2021-02-boundary-extraction-region-filling-4953068446934987404.png)


 2.Erosion結果，肉眼看不出，但亮部已經變小了。 

![image](images/2021-02-boundary-extraction-region-filling-2218362944917187230.png)

3.相減之後可以得到邊緣

![image](images/2021-02-boundary-extraction-region-filling-2705310860940084995.png)
...
![image](images/2021-02-boundary-extraction-region-filling-6140869818833831458.png)


NOT後得到補數圖

![image](images/2021-02-boundary-extraction-region-filling-5000025061347924167.png)

 每次Dilate後白色膨脹，跟補數做AND，做完數次後得到以下。

![image](images/2021-02-boundary-extraction-region-filling-7905739167554830244.png)

 最後把原圖和Dialte後的圖做OR得到填充的圖。

![image](images/2021-02-boundary-extraction-region-filling-6848413098474797101.png)

預先撒上白點才能正確做到填充效果，其實也只是把白點放大再放大，然後再用原始圖去限縮他的邊界，避免失真。我曾嘗試用Erode後的圖取補數再去填充，但是會發現沒法控制邊緣一直變大，後來才改回原圖的補數去填充，就可以應付各種形狀的填充，跟小畫家的效果一樣，即便是用不規則的圖也可以被補數解決掉，還原出原本的形狀。

![](https://i0.wp.com/liuchien.ink.tw/wp-content/uploads/2021/02/image-10.png?w=525&ssl=1)

![image](images/2021-02-boundary-extraction-region-filling-7380478764248436247.png)




![image](images/2021-02-boundary-extraction-region-filling-3852758280438208498.png)




![image](images/2021-02-boundary-extraction-region-filling-5567504018759246916.png)




![image](images/2021-02-boundary-extraction-region-filling-6959416743416047278.png)
